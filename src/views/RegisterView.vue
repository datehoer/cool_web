        ...
        <el-form ref="signUpFormRef" :model="signUpForm" :rules="signUpRules" class="login-form">
          ...
          <el-form-item prop="code">
            <div class="code-container">
                ...
                <el-button :disabled="isCodeButtonDisabled" @click="handleSendCode" class="code-btn">发送验证码</el-button>
            </div>
            </el-form-item>
          <el-form-item>
...
.login-container {
  ...
  align-items: center;
  min-height: 100vh; /* 用 min-height 保证至少100% 的视口高度 */
  background: linear-gradient(to right, #a18cd1, #fbc2eb);
}

.box-card {
  width: 400px;
  max-width: 100%; /* 防止在小屏幕上超出视口宽度 */
  padding: 35px;
